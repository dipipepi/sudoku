...
import {StyledCreateNewGameButton, StyledGameWrapper, StyledSudokuHeader, StyledWrapper } from "./style";
        ...
        <>
            {isNewGame ?
                ...
                wasSudokuGridInit ?
                    <StyledWrapper>
                        <div>
                            <StyledCreateNewGameButton onClick={startNewGame}>New Game</StyledCreateNewGameButton>
                        </div>
                        <StyledGameWrapper>
